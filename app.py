...
def transport_comparison_chart(options: list, pax: int):
    ...
    fig.update_layout(**PLOTLY_LAYOUT, height=300,
        yaxis=dict(title=dict(text="Total Cost (₹)", font=dict(color="#7070a0")), tickfont=dict(color="#7070a0"), gridcolor="#2a2a3a"),
        yaxis2=dict(title=dict(text="Rating", font=dict(color="#ff6b9d")), tickfont=dict(color="#ff6b9d"), overlaying="y", side="right", range=[0, 5]),
